...
\title{\includegraphics[height=0.7in]{scalpel.pdf} \\ ~ \\ ~ \\ \color{WildStrawberry}\Huge{ Lavoisier \\ ~ } \includegraphics[height=1.5in]{eye.pdf} \\ {\huge{ ~ \\ \color{RubineRed}\textsc{or: Tales of an Amoral Medic}}}
\date{}
